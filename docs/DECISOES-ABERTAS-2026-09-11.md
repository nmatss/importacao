...
## Decisão confirmada pelo solicitante em 12/09/2026

**Dia limite inclusivo:** venda permitida até o fim do dia do prazo final aprovado em
`America/Sao_Paulo`; bloqueio a partir de 00:00 do dia seguinte nesse fuso. Vale para o menor
prazo comercial aplicável, sem transformar validade do certificado em fim de venda.
Fonte: resposta do solicitante “Permitida até o fim do dia limite”. Testes de fronteira anteriores
cobrem essa política; esta decisão deixa de ser pendência para homologação/carga.

As opções abaixo são histórico da reunião e não constituem aprovação automática. Prevalecem
as correções/decisões atuais no relatório de retomada. Permanecem pendentes os vínculos vigentes,
a aplicabilidade do licenciamento e a conciliação da carga.

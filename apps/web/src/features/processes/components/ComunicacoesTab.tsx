      ...
      {hasDrafts && emailSignatures && emailSignatures.length > 0 && (
        <div className="rounded-xl border border-slate-200/80 bg-slate-50 p-4">
          ...
          <select
            ...
            className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none transition-all"
          >

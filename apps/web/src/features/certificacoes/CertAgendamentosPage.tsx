    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100">Agendamentos</h1>
            <p className="text-sm text-slate-600 dark:text-slate-300">
              Configure validações automáticas recorrentes
            </p>
          </div>
        </div>
        <button
        ...
        <div className="rounded-2xl border border-slate-200/60 dark:border-slate-700/60 shadow-sm bg-white dark:bg-slate-800 flex flex-col items-center justify-center py-20 px-6">
          ...
          {hasDateFilter ? (
            <>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300 text-center max-w-sm mb-5">
                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-2">
                      <h2
                        className={`text-base font-semibold truncate ${schedule.enabled ? 'text-slate-900 dark:text-slate-100' : 'text-slate-500'}`}
                      >
                        {schedule.name}
                      </h2>
                      <span
                    ...
                    <div className="flex flex-wrap items-center gap-x-5 gap-y-1 mt-3 text-xs text-slate-600 dark:text-slate-300">
                      {schedule.last_run && (
                        <span>
                          Última execução:{' '}

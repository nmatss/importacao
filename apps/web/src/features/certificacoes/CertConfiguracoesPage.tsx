        ...
        <div className="p-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-700 text-white shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800/80 transition-colors">
                ...
                <div className="flex items-center gap-2">
                  {apiHealthy && stats ? (
                    ...
                    <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-700/60 px-3 py-1.5 rounded-lg">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800/80 transition-colors">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      puket.com.br, loja.imaginarium.com.br
                    </p>
                  </div>
                </div>
      ...
      <div className="rounded-2xl border border-slate-200/60 dark:border-slate-700/60 shadow-sm bg-white dark:bg-slate-800">
        <div className="p-6">
          ...
          <div className="space-y-6 text-sm text-slate-600 dark:text-slate-400">
            ...
            <div className="flex items-center gap-2.5 text-xs text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-slate-900 rounded-xl px-4 py-3 border border-slate-100 dark:border-slate-700">
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="rounded-xl bg-slate-50/80 border border-slate-100 dark:border-slate-700 p-4">
              ...
              <p className="text-lg font-bold text-slate-900 dark:text-slate-100">1.5s</p>
            </div>
          </div>
        </div>
      </div>
